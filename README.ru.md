...
10 КБ, без зависимостей, разметка в теневом дереве — стили ни в одну сторону не протекают. Ответ идёт потоком через SSE, реплики менеджера подтягиваются опросом.
